<template>
  ...
  <div class="q-gutter-y-md" style="max-width: 80%; margin: 0 auto;">
      ...
      <q-space/>
      <q-btn class="q-my-lg" v-if="((data.tipo_reparo && data.tipo_reparo == 9) || data.descricao_intervencao == 'Acessórios') && step == 1" label="Liberar OS" color="red" icon="done" @click="liberarOSAcessorio()"> </q-btn>
        <q-btn class="q-my-lg" v-if="((data.tipo_reparo && data.tipo_reparo !=9) && data.descricao_intervencao != 'Acessórios') && step == 1" label="Enviar para Laboratório" color="red" icon="keyboard_tab" @click="openEnviarOficina()"> </q-btn>
      </div>
        </q-tab-panel>
